...
{
	class HeroInfo7 : BaseCommand
	{
		public override string command_name { get { return "HeroInfo7"; } }
		public static Regex regex = new Regex(String.Format("^\\{0}heroinfo7(?:\\s+(.+))?$", FleepBot.Program.COMMAND_PREFIX), RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.Singleline);
