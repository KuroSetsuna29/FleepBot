...
namespace FleepBot.Commands
{
	...
	{
		public override string command_name { get { return "ListMembers"; } }
		public static Regex regex = new Regex(String.Format("^\\{0}listmembers(?:\\s+(.+))?$", FleepBot.Program.ADMIN_COMMAND_PREFIX), RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.Singleline);
