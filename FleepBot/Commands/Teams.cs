...
namespace FleepBot.Commands
{
	...
	{
		public override string command_name { get { return "Teams"; } }
		public static Regex regex = new Regex(String.Format("^\\{0}teams(?:\\s+(.+))?$", FleepBot.Program.COMMAND_PREFIX), RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.Singleline);
