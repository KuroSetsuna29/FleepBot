...
{
    class WhoIsOn : BaseCommand
	{
		public override string command_name { get { return "WhoIsOn"; } }
		public static Regex regex = new Regex(String.Format("^\\{0}whoison(?:\\s+(.+))?$", FleepBot.Program.COMMAND_PREFIX), RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.Singleline);
